...
// define(function(require) {
  ...
  ImageUtil.Filters = {
    ...
    convolute: function(imageData, options) {
      ...
      var outputImageData = ImageUtil.createImageData(w, h);
    ...
    sharpen: function(imageData, options) {
      var v = 5;
      return ImageUtil.Filters.convolute(imageData, {
        weights: [ 0, -1,  0,
                  -1,  v, -1,
                   0, -1,  0 ]
      });
  ...
  ImageUtil.createContext = function(width, height) {
  ...
  ImageUtil.createImageData = function(width, height) {
    var ctx = ImageUtil.createContext(width, height);
  ...
  ImageUtil.prototype = {
    ...
    scale: function(scale) {
      ...
      ctx.drawImage(image, 0, 0, width, height, offsetX, offsetY, outputWidth, outputHeight);
